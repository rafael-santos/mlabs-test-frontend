<template>
  <div class="h-100">
    <div class="social-widget-new">
      <span v-if="channel.beta"
        class="badge badge--secondary badge--medium social-widget-new__badge">
        Beta
      </span>
      <div class="social-widget-new__icon-container"
        :class="`social-widget-new__icon-container--${channel.channelKey}`">
