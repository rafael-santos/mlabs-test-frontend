export default [
  ...
  { channelKey: 'google-my-business', name: 'Google meu negócio', beta: true },
  { channelKey: 'pinterest', name: 'Pinterest' },
  { channelKey: 'linkedin', name: 'Linkedin' },
  { channelKey: 'youtube', name: 'Youtube' },
  { channelKey: 'whatsapp', name: 'WhatsApp', beta: true },
  { channelKey: 'google-analytics', name: 'Google Analytics' }
];
